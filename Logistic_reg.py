...
class Logistic_Regression:
	...
	def predict(self):
		...
		if self.label == 'A':
			...
			#print('G',self.precent)
			tmp = int(int(self.precent)*self.sizeTrain/20)
			#print(tmp)
			Xfortrain, Yfortrain = self.Xdata[0:tmp*1, :], self.Ytarget[0:tmp*1]
